...
export const Events = [
    {
        ...
        type: "doctor",
        fullDay: true,
        start: today.setDate(28).addMonth(-1).target,
    ...
    {
        name: "Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression.",
